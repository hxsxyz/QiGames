...
- (instancetype)init {
    ...
    if (self) {
        ...
        NSString *customWords = @"南瓜屋,智能物联,嵌入式,产品经理,设计师,iOS,安卓,网络安全学院,起舞学院,QiShare,奇效,开放平台,1024,小水滴,行车记录仪,扫地机器人,智能门锁,香山体脂称,欧瑞博门锁,乐高路由器,儿童手表,智能牙刷,智能插座,web平台,奇舞团,IoT云平台,QTest,MQTT,XLink,PHP,Python,Go,Java,HTML,C#,Photoshop,Axsure,AI,图层,蒙版,原型,高保真,公众号,文案,回滚,bug,搜索,游戏,";
...
- (NSString *)randomWord {
    ...
    NSString *randomWord = index < words.count? words[index]: @"Error";
