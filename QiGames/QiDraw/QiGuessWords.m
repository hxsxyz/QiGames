...
@property (nonatomic, copy) NSMutableArray<NSString *> *personWords;//!< 任务词条
...
- (instancetype)init {
    ...
    if (self) {
        ...
        NSString *customWords = @"我信你个鬼,好嗨哟,你品，你细品,断舍离,老司机带带我,年轻人不讲武德,来了老弟,杠精,白嫖,凉凉,又是元气满满的一天,扎心了，老铁,雨女无瓜,巨婴,我太难了,你懂的,神仙打架,实锤,真香,社畜,鸡你太美,我方了,可可爱爱,你大爷还是你大爷,盘他,舔狗,欧气,多喝热水,爱的魔力转圈圈,怪我咯,转发这条锦鲤,吃你家大米了,素质三连,上头,溜了溜了,肥宅快乐水,尬聊,啾咪,干就完事了,硬核,你是什么垃圾,明星同款,面对激风暴,你看这个碗它又大又圆,保温杯里泡枸杞,打call,令人窒息的操作,人间不值得,老哥稳,啥是佩奇,不，你不想,补刀,会说话你就多说点,求生欲,带节奏,辣眼睛,原谅我不厚道地笑了,文明互鉴,加持,笑容渐渐凝固,疑车无据,佛系,你这是在玩火,DUCK不必,打工人,后浪,996,特朗普,爷青结,直播带货,奥利给,乘风破浪,后浪,打call,彩虹屁,小程序,怼,耗子尾汁,干饭人,直播,一起爬山吗,割韭菜,口罩,5G,凡尔赛,女装大佬,BUG,单身狗,王者荣耀,狗粮";
        
        NSString *personWords = @"猪八戒,周杰伦,武则天,唐伯虎,孙悟空,鲁智深,白骨精,韦小宝,灭绝师太,张三丰,段誉,金毛狮王,紫薇,黄飞鸿,纪晓岚,步惊云,罗永浩,王思聪,杨超越";
...
//        NSString *customWords = @"南瓜屋,智能物联,嵌入式,产品经理,设计师,iOS,安卓,网络安全学院,奇舞学院,QiShare,奇舞周刊,奇效,开放平台,1024,小水滴,行车记录仪,扫地机器人,智能门锁,香山体脂称,欧瑞博门锁,乐高路由器,儿童手表,智能牙刷,智能插座,WEB平台,奇舞团,IoT云平台,QTest,MQTT,XLink,PHP,Python,Go,Java,HTML,Linux,Unix,C#,Photoshop,Axsure,AI,图层,原型,高保真,公众号,文案,回滚,bug,搜索,游戏,360杀毒,鲁大师,QPush,定时,OTA,360商城,帐号卫士,0配,花椒直播,一键配,固件,单片机,MAC,可穿戴设备,设备管理,互联互通,图像识别,数据可视化,UDP,TCP,高保真,人机交互,语音识别,消息推送,电脑软件,手机软件,视频直播,金融科技,个人服务,安全理赔,企业服务,安全卫士,手机助手,清理大师,安全路由,登录,注册,首页,资源中心,数据中心,产品管理,深耕安全十三年,安全设备认证,漏洞管理,智能硬件安全,敏感信息保护,云端安全,数据安全存储,扫码关注,二维码,海量数据分析,大数据挖掘,用户画像,实时运算,用户中心,鲁大师,快视频,北京时间,快资讯,你财富,同城帮";
        ...
        _personWords = [personWords componentsSeparatedByString:@","].mutableCopy;
        _allWords = @[_primaryWords, _middleWords, _seniorWords, _complexWords,_personWords,_customWords];
    }
